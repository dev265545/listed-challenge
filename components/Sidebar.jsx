...
const Sidebar = () => {
  return (
    <>
      ...
      <aside
        id="default-sidebar"
        class=" rounded-full p-3 top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidenav"
      >
        <div class="overflow-y-auto rounded-3xl py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-black dark:border-gray-700">
          <ul class="space-y-2 py-5">
            <li>
              <a
                href="#"
                class="flex text-3xl items-center p-2 mb-10 font-bold text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
            ...
            <li>
              <button
                type="button"
                class="flex items-center p-2 w-full text-base  font-montserrat font-bold text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
