...
function Sidebar() {
  ...
  return (
    <div className="p-6">
      <Disclosure as="nav">
        <Disclosure.Button className=" fixed top-0  peer rounded-md p-1 px-2 py-3 text-gray-800 hover:bg-gradient-radial  hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white group">
          <GiHamburgerMenu
            className="block lg:hidden z-50  h-6 w-6"
            aria-hidden="true"
          />
        </Disclosure.Button>
        <div className="p-6 w-1/2 h-screen bg-black rounded-2xl fixed z-20  top-0     -left-full lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-100">
          <div className="flex flex-col justify-start item-center">
            ...
            <ul class="space-y-2 py-5">
              <li>
                <a
                  href="#"
                  class="flex text-3xl items-center p-2 mb-10 font-bold rounded-lg text-white group"
                >
              ...
              <li>
                <button
                  type="button"
                  class="flex items-center p-2 w-full text-base  font-montserrat font-bold  rounded-lg transition duration-75 group text-white hover:bg-gray-700"
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M16.9379 10.8546C16.8263 10.8147 16.7078 10.7972 16.5894 10.8033C16.4709 10.8093 16.3548 10.8386 16.2478 10.8896C16.1407 10.9407 16.0448 11.0123 15.9655 11.1005C15.8863 11.1888 15.8252 11.2918 15.7859 11.4036C15.3803 12.5502 14.6908 13.5754 13.7819 14.3835C12.873 15.1916 11.7741 15.7563 10.5879 16.0249C9.40176 16.2935 8.16686 16.2573 6.99846 15.9196C5.83006 15.5819 4.76623 14.9538 3.90623 14.0938C3.04623 13.2338 2.41809 12.1699 2.0804 11.0015C1.74271 9.83315 1.70648 8.59825 1.97509 7.41206C2.2437 6.22587 2.80839 5.12705 3.61649 4.21811C4.42459 3.30917 5.44976 2.61974 6.59636 2.21413C6.82193 2.13535 7.00698 1.97019 7.11079 1.75498C7.2146 1.53977 7.22866 1.29214 7.14989 1.06656C7.07111 0.840983 6.90595 0.655935 6.69074 0.552128C6.47553 0.448321 6.2279 0.434257 6.00232 0.513031C4.56858 1.01956 3.28654 1.88108 2.27585 3.01717C1.26517 4.15327 0.558799 5.5269 0.222663 7.00987C-0.113472 8.49285 -0.0684124 10.0368 0.353638 11.4976C0.775688 12.9585 1.56097 14.2886 2.63619 15.3638C3.71141 16.439 5.04151 17.2243 6.50235 17.6464C7.9632 18.0684 9.50716 18.1135 10.9901 17.7773C12.4731 17.4412 13.8467 16.7348 14.9828 15.7241C16.1189 14.7135 16.9804 13.4314 17.487 11.9977C17.5648 11.7733 17.5508 11.5272 17.4479 11.313C17.3451 11.0989 17.1618 10.9341 16.9379 10.8546Z"
                      fill="white"
                    />
                  </svg>
              ...
              <li>
                <button
                  type="button"
                  class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-500 dark:text-white dark:hover:bg-gray-700"
                ...
                >
                  ...
                  <span class="flex-1 ml-3 text-white font-montserrat  text-left whitespace-nowrap">
                    Transactions
                  </span>
                </button>
              </li>
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M8.99999 3.85715C8.36427 3.85715 7.74282 4.04566 7.21423 4.39885C6.68564 4.75204 6.27366 5.25405 6.03038 5.84138C5.7871 6.42871 5.72344 7.075 5.84747 7.69851C5.97149 8.32202 6.27762 8.89475 6.72715 9.34427C7.17668 9.7938 7.74941 10.0999 8.37292 10.224C8.99643 10.348 9.64271 10.2843 10.23 10.041C10.8174 9.79776 11.3194 9.38578 11.6726 8.85719C12.0258 8.32861 12.2143 7.70716 12.2143 7.07143C12.2143 6.21895 11.8756 5.40138 11.2728 4.79859C10.67 4.19579 9.85247 3.85715 8.99999 3.85715ZM8.99999 9C8.61856 9 8.24569 8.88689 7.92854 8.67498C7.61138 8.46307 7.36419 8.16186 7.21822 7.80946C7.07226 7.45706 7.03406 7.06929 7.10848 6.69519C7.18289 6.32108 7.36657 5.97744 7.63629 5.70773C7.906 5.43801 8.24964 5.25433 8.62375 5.17992C8.99785 5.1055 9.38562 5.1437 9.73802 5.28966C10.0904 5.43563 10.3916 5.68282 10.6035 5.99998C10.8155 6.31713 10.9286 6.69 10.9286 7.07143C10.9281 7.58276 10.7247 8.07301 10.3631 8.43457C10.0016 8.79614 9.51132 8.99949 8.99999 9Z"
                      fill="white"
                    />
                    <path
            ...
            <div class=" text-white pt-48 mt-12 flex flex-col  px-6 gap-4">
            <p>Help</p>
            <p>Contact us</p>
          </div>
           </div>
